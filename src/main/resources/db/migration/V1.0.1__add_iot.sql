...
CONSTRAINT FK_iot_person_id FOREIGN KEY (person_id) REFERENCES lifetech.person(id)
);
...
percentage VARCHAR(5),
person_id  BIGINT UNSIGNED NOT NULL,
CONSTRAINT FK_shutter_person_id FOREIGN KEY (person_id) REFERENCES lifetech.person(id)
);
...
maxvalueref VARCHAR(255),
person_id  BIGINT UNSIGNED NOT NULL,
CONSTRAINT FK_heater_person_id FOREIGN KEY (person_id) REFERENCES lifetech.person(id)
);
...
maxvalueref VARCHAR(255),
person_id  BIGINT UNSIGNED NOT NULL,
CONSTRAINT FK_clock_person_id FOREIGN KEY (person_id) REFERENCES lifetech.person(id)
);
