...
INSERT INTO lifetech.light (ipadress, state, breakdownstatus, percentage, color, person_id, room_id) VALUES ('172.163.92.0','ON','NOT_BREAKDOWN', '92%', 'blue', 1, 1);
...
INSERT INTO lifetech.shutter (ipadress, state,breakdownstatus, percentage, person_id, room_id) VALUES ('172.163.92.12','ON','NOT_BREAKDOWN', '50%', 3, 3);
